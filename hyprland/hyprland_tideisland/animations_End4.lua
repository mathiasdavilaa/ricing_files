...
hl.animation({ leaf = "layersIn", enabled = true, speed = 4, bezier = "easeOutExpo", style = "slide bottom" })
hl.animation({ leaf = "layersOut", enabled = true, speed = 3, bezier = "easeInOutCirc", style = "slide bottom" })
